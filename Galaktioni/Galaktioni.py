...
# Main loop for text generation
while True:
    print(" ")
    print("Type: 'infinite' / 'უსასრულო' for loop")
    print("Type 'stop' / 'დასასრული' to end")
    print(" ")
    initial_text = input("სათაური: ")
    if initial_text.lower() == 'stop' or initial_text == 'დასასრული':
        print(" ")
        print("დასასრული.")
        break
    if initial_text.strip() == '':
        initial_text = '***'
    if initial_text.lower() == 'infinite' or initial_text == 'უსასრულო':
        # Infinite text generation loop
        while True:
            generated_tokens = m.generate(context, max_new_tokens=1)[0].tolist()
        ...
        generated_tokens = m.generate(initial_context_tensor, max_new_tokens=512)[0].tolist()
        generated_text = decode(generated_tokens)
